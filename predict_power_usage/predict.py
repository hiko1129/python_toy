...
def get_weather_df(input_files, output_file, skiprows_dict):
...
def get_demand_date_list(filename, header):
    """データの準備."""
...
def prepare_data(input_filenames, output_filename, objective_filename, skiprows_list=[4, 4, 4, 4], demand_header=1):
    input_files = {
    ...
    weather_df = get_weather_df(input_files, output_filename, skiprows_dict)
    demand_list, month_list, day_list, time_list = get_demand_date_list(objective_filename, demand_header)
